...
public class EnderDragonPet extends EntityEnderDragon implements FlyingPet {
	...
	public EnderDragonPet(World world) {
		super(world);
	}
			...
			if(!onGround && forMot > 0.5) { // check if entity is flying and player is moving forward
				Vector
					...
					player.getLocation().getDirection()
						.normalize(); // Apply additional motion in players direction (falling overrides motion set in super.g(..))
